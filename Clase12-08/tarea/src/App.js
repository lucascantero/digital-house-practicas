...
function App() {
	let arr = [
		{text:'Products in Data Base', num:'135', color: 'primary', icon:'fa-clipboard-list'},
		{text:'Amount in products', num:'$546.456', color:'success', icon:'fa-dollar-sign'},
		{text :'Users quantity', num :'38',color:'warning',icon:'fa-user-check'}
	]
  return (
    <div id="wrapper">
